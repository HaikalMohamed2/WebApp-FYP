  ...
  <header>
    <nav class="navbar navbar-expand-lg NavFont NavColor">
      <div class="container-fluid">
        <a href="../index.php" class="navbar-brand"><img src="..\SourceImg\SEMUJA.png" width="20%" height="20%"></a>
        ...
        <!-- Pagination links -->
          ...
          <div class="row justify-content-center">
            <div class="col-6 text-center">
              <a href="..\Dashboard\GenerateReport.php" class="btn btn-primary">Generate Report</a>
            </div>
          </div>
      </div>
    </div>
